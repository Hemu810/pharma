  ...
  return (
    <div className="home-wrap">
      ...
      <div className="home-body">
          ...
          <div>
            ...
            <div className="kpi-mini-grid">
              <div className="home-kpi">
                ...
                <div className="home-kpi-value">{modules.drugs.count}</div>
              </div>
              <div className="home-kpi">
                <div className="home-kpi-label">Trials recruiting</div>
                <div className="home-kpi-value">{modules.trials.count}</div>
              </div>
              <div className="home-kpi">
        ...
        {showPortfolioAnalytics && <PortfolioAnalytics modules={modules} />}
